...
#'  output:
#'  - fig_human: '`sm config["FIGURE_DIR"] + "/Fig3_a_human.pdf"`'
#'  - fig: '`sm config["FIGURE_DIR"] + "/Fig3_a.pdf"`'
#' output: 
#'   html_document:
#'    code_folding: hide
#'    code_download: TRUE
...
fig_human <- gganatogram(data=  patients[SAMPLE_ID == "OM57837"], 
                         fillOutline='white', organism='human', 
                         sex= unique(patients[SAMPLE_ID == "OM57837"]$sex), 
                         fill="colour")+ 
  theme_void() + 
...
pdf(snakemake@output$fig_human, # "/s/project/mitoMultiOmics/multiOMICs_integration/Figures/Fig3_a_human.pdf",  
...
pdf(snakemake@output$fig, # "/s/project/mitoMultiOmics/multiOMICs_integration/Figures/Fig3_a.pdf",  
