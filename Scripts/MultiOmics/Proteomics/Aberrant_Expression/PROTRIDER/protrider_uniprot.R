...
#'   - protr_out: '`sm config["PROC_DATA"] + "/protrider_uniprot"`'
#'  output:
#'   - protrider_annotation: '`sm config["PROC_DATA"] + "/protrider_uniprot/protrider_annotation.tsv"`'
#'   - protrider_data: '`sm config["PROC_DATA"] + "/protrider_uniprot/protrider_data.tsv"`'
#'   - protrider_config: '`sm config["PROC_DATA"] + "/protrider_uniprot/config_protrider.yaml"`'
#'   - protrider_resultsu: '`sm config["PROC_DATA"] + "/protrider_uniprot/PROTRIDER_results.rds"`'
#'  type: script
#'---
...
dir.create("/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot", recursive = TRUE, showWarnings = FALSE)
...
write_tsv(sa, "/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot/protrider_annotation.tsv")
...
write_tsv(protrider_data, "/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot/protrider_data.tsv")
...
config_list$out_dir <- "/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot"

# Write the updated configuration file to output
yaml::write_yaml(config_list, snakemake@output$protrider_config)
yaml::write_yaml(config_list, "/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot/config_protrider.yaml")
...
config_path <- "/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot/config_protrider.yaml"
input_intensities <- "/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot/protrider_data.tsv"
sample_annotation <- "/Users/Mitya/Desktop/working/omicsDagnostics_data/processed_data/protrider_uniprot/protrider_annotation.tsv"
...
saveRDS(res, snakemake@output$protrider_resultsu)
